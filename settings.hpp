...
const int MINI_MAP_WIDTH = 1200;
const int MINI_MAP_HEIGHT = 1200;
const int MINI_MAP_X = HALF_WIDTH - MINI_MAP_WIDTH / 2;
const int MINI_MAP_Y = HALF_HEIGHT - MINI_MAP_HEIGHT / 2;
